...
option checks, report generation, report-schema checks (including JSON↔Markdown count parity), and concise step-summary publication (from JSON report data) + artifact upload).
