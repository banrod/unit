...
lives in `notes/registry-report.md` (and `notes/registry-report.json` for machine-readable automation with schema + issue summary). To profile the image-filter prototype at
